...
Route::get('contact-us',['as'=>'contact-us','uses'=>'HomeController@getContact']);*/
    ...
    Route::group(['prefix' => 'admin'], function () {
        ...
        Route::get('messages-cus','DashboardController@customerMessages')->name('messages-cus');

        Route::post('replay-message/{id}','DashboardController@replayMessage')->name('replay');
    ...
    Route::post('customer', 'Customer\LoginController@login')->name('customer.login.post');


    Route::get('customer-dashboard',['as'=>'customer-dashboard','uses'=>'Customer\CustomerController@getDashboard']);
    Route::get('customer-logout', 'Customer\LoginController@logout')->name('customer.logout');


    Route::get('customer/edit-profile',['as'=>'customer-edit-profile','uses'=>'Customer\CustomerController@editProfile']);
    Route::post('customer/edit-profile',['as'=>'customer-update-profile','uses'=>'Customer\CustomerController@updateProfile'])->name('customer.edit-profile');


    Route::get('customer/edit-password',['as'=>'customer-edit-password','uses'=>'Customer\CustomerController@editPassword']);
    Route::post('customer/edit-password',['as'=>'customer-update-password','uses'=>'Customer\CustomerController@updatePassword'])->name('customer.edit-profile');


    Route::get('customer/orders','Customer\CustomerController@myOrder');


    Route::get('customer/products/','Customer\CustomerController@myProduct');
    Route::get('customer/products/invoice','Customer\CustomerController@myProduct')->name('cus.inv');

    Route::get('customer/chart' , 'Customer\CustomerController@chart')->name('chart');


    Route::post('send/message' , 'Customer\CustomerController@sendMessage')->name('send.message');



    Route::get('customer/add-comment-to-product','Customer\CustomerController@customer/addCommentToProduct');
