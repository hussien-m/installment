                            ...
                            {!! Form::model($customer,['route'=>['customer-update',$customer->id],'class'=>'form-horizontal','method'=>'put','role'=>'form']) !!}
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="balance" id=""  class="form-control input-lg" placeholder="Customer Balance" required  value="{{ $customer->balance }}">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-12"><strong style="text-transform: uppercase;">Add Balance</strong></label>
                                        <div class="col-md-12">
                                            <input type="number" name="add_balance" id="" cols="30" rows="5" class="form-control input-lg" placeholder="add value" required autocomplete="false" value="0" >
                                        </div>
                                    </div>
