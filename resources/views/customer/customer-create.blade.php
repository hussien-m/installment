                            ...
                            <form class="form-horizontal" method="post" role="form">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="number" name="balance" id="" cols="30" rows="5" class="form-control input-lg" placeholder="" disable="true">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="password" name="password" id="" cols="30" rows="5" class="form-control input-lg" placeholder="Customer Address" required>
                                        </div>
                                    </div>
